...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/www/wmcads-website.js");
/******/ })
/************************************************************************/
/******/ ({
...
var cookies = function cookies() {
  var cookiesBanner = document.querySelector('header .wmcads-cookies-banner');
  ...
  var showCookieBanner = function showCookieBanner() {
    var codeExample = document.querySelector('.wmcads-website-code-example .wmcads-cookies-banner');
  ...
  var updateCookiePreferences = function updateCookiePreferences() {
    if (document.querySelector('.wmcads-cookies-manager__preferences')) {
      hideCookieBanner();
      var cookiesOptions = document.querySelector('.wmcads-cookies-manager__preferences').querySelectorAll('.wmcads-fe-checkboxes__input');
  ...
  var savePreferences = function savePreferences() {
    if (document.querySelector('.wmcads-cookies-manager__form')) {
      var elements = document.querySelector('.wmcads-cookies-manager__form').querySelectorAll('.wmcads-fe-checkboxes__input');
      var selectedOptions = [];
  ...
  var acceptAllCookiesBtn = document.querySelector('.wmcads-cookies-banner__accept-all-cookies');
  ...
  var cookieForm = document.querySelector('.wmcads-cookies-manager__form');
...
/***/ "./src/wmcads/patterns/header/_example.js":
/*!************************************************!*\
  !*** ./src/wmcads/patterns/header/_example.js ***!
  \************************************************/
/*! exports provided: default */
  ...
  megaMenus.forEach(function (menu) {
    ...
    function handleMobileMenu(mq) {
      if (mq.matches) {
        ...
        var searchBtn = menu.querySelector('.wmcads-mega-menu__search-btn'); // object to see which menu/menu level is open
    ...
    topLevelLinks.forEach(function (topLevelLink, topLevelLinkIndex) {
      ...
      var subMenuLinks = topLevelListItem.querySelectorAll('.wmcads-mega-menu__sub-menu-link'); // check if level 3 menus are present, if so add modifier class
      ...
      var handleKeydown = function handleKeydown(e, key) {
        e.stopPropagation(); // if key pressed is enter, space bar or down arrow
      ...
      if (subMenuContainer) {
        setKeyboardNavigation(subMenuContainer, '.wmcads-mega-menu__sub-menu-item', // what to do on first link
        function () {
    ...
    if (searchMenuContainer) {
      setKeyboardNavigation(searchMenuContainer, '.wmcads-search-list', // what to do on first link
      function () {
...
var componentExampleIframe = function componentExampleIframe() {
  var iframeExamples = document.querySelectorAll('.wmcads-website-code-example__iframe');
  iframeExamples.forEach(function (iframeElement) {
    var ifrm = iframeElement; // get iframe content

    var html = ifrm.dataset.src; // clear unnecessary html

    ifrm.innerHTML = '';
    var host = "//".concat(window.location.host);
    var ajax = new XMLHttpRequest();
    ajax.open('GET', "".concat(host, "/img/wmcads-icons.min.svg"), true); // Fire off ajax to get spritesheet

    ajax.send(); // When spritesheet has loaded
...
var componentExampleScript = function componentExampleScript() {
  var exampleScripts = document.querySelectorAll('.wmcads-website-code-example__js'); // Get all code examples that have the js tab enabled
...
var seeExampleFullScreen = function seeExampleFullScreen() {
  var fullScreenBtns = document.querySelectorAll('.wmcads-website-code-example__view-fullscreen');
      ...
      if (isEscPressed) {
        ...
        document.removeEventListener('keydown', handleFullScreenKeyDown); // Remove listener as we want to go back to normal keyboard events
          ...
          if (document.activeElement === firstFocusableElement) {
            ...
            e.preventDefault(); // if focused has reached to last focusable element then focus first focusable element after pressing tab
...
/*!******************************************************!*\
  !*** ./src/www/_partials/component-example/index.js ***!
  \******************************************************/
/*! exports provided: componentExample, componentExampleScript, componentExampleIframe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "componentExample", function() { return _component_example__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "componentExampleScript", function() { return _component_example_script__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "componentExampleIframe", function() { return _component_example_iframe__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
/* empty/unused harmony star reexport *//* harmony import */ var _includes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./includes */ "./src/www/assets/vendor/js/polyfills/includes.js");
/* empty/unused harmony star reexport *//* harmony import */ var _details_element__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./details-element */ "./src/www/assets/vendor/js/polyfills/details-element.js");
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _details_element__WEBPACK_IMPORTED_MODULE_2__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _details_element__WEBPACK_IMPORTED_MODULE_2__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
function aToZContentStyleGuide() {
  ...
  var changeAccordionState = function changeAccordionState(accordionElem) {
    ...
    var accordionBtn = accordionElem.querySelector('.wmcads-accordion__summary-wrapper');
  ...
  var changeAllAccordionStates = function changeAllAccordionStates(changeStateToOpen) {
    var accordions = document.querySelectorAll('main .wmcads-accordion');
    accordions.forEach(function (accordion) {
  ...
  var setupScrollToAnchor = function setupScrollToAnchor() {
    var anchors = document.querySelectorAll('main a[href^="#"]:not([href="#"])'); // Loop through an add event listener
...
function colorPalettes() {
  var colors = document.querySelectorAll('.wmcads-website-color-swatch__inner'); // Function to convert rgb to hex
...
/* harmony import */ var _assets_vendor_js_polyfills_polyfills__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/vendor/js/polyfills/polyfills */ "./src/www/assets/vendor/js/polyfills/polyfills.js");
/* harmony import */ var _pages_styles_colour_palettes_color_palettes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/styles/colour-palettes/_color-palettes */ "./src/www/pages/styles/colour-palettes/_color-palettes.js");
/* harmony import */ var _pages_styles_a_to_z_content_style_guide_a_to_z_content_style_guide__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/styles/a-to-z-content-style-guide/_a-to-z-content-style-guide */ "./src/www/pages/styles/a-to-z-content-style-guide/_a-to-z-content-style-guide.js");
/* harmony import */ var _wmcads_patterns_cookies_example__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../wmcads/patterns/cookies/_example */ "./src/wmcads/patterns/cookies/_example.js");
/* harmony import */ var _wmcads_patterns_header_example__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../wmcads/patterns/header/_example */ "./src/wmcads/patterns/header/_example.js");
/* harmony import */ var _wmcads_patterns_footer_example__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../wmcads/patterns/footer/_example */ "./src/wmcads/patterns/footer/_example.js");
/* harmony import */ var _wmcads_components_accordion_example__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../wmcads/components/accordion/_example */ "./src/wmcads/components/accordion/_example.js");
...
if (!isInIframe && "development" === 'production') _sentry_browser__WEBPACK_IMPORTED_MODULE_0__["init"]({
...
window.addEventListener('DOMContentLoaded', (_assets_vendor_js_polyfills_polyfills__WEBPACK_IMPORTED_MODULE_1__, icons(), Object(_pages_styles_a_to_z_content_style_guide_a_to_z_content_style_guide__WEBPACK_IMPORTED_MODULE_3__["default"])(), Object(_pages_styles_colour_palettes_color_palettes__WEBPACK_IMPORTED_MODULE_2__["default"])(), Object(_wmcads_patterns_header_example__WEBPACK_IMPORTED_MODULE_5__["default"])(), Object(_wmcads_patterns_footer_example__WEBPACK_IMPORTED_MODULE_6__["default"])(), Object(_wmcads_components_accordion_example__WEBPACK_IMPORTED_MODULE_7__["default"])(), Object(_wmcads_patterns_cookies_example__WEBPACK_IMPORTED_MODULE_4__["default"])(), Object(_wmcads_patterns_search_search_filter_example__WEBPACK_IMPORTED_MODULE_8__["default"])(), Object(_partials_component_example__WEBPACK_IMPORTED_MODULE_9__["componentExampleIframe"])(), Object(_partials_component_example__WEBPACK_IMPORTED_MODULE_9__["componentExampleScript"])(), _partials_component_example__WEBPACK_IMPORTED_MODULE_9__["componentExample"]));

/***/ })

/******/ });
//# sourceMappingURL=wmcads-website.min.js.map