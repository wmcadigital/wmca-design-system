...
var componentExampleIframe = function componentExampleIframe() {
  ...
  iframeExamples.forEach(function (iframeElement) {
    ...
    ajax.open('GET', "".concat(host, "/wmca-design-system/img/ds-icons.min.svg"), true); // Fire off ajax to get spritesheet
    ajax.send();
...
var icons = function icons() {
  ...
  var ajax = new XMLHttpRequest();
  ajax.open('GET', '/wmca-design-system/img/ds-icons.min.svg', true);
  ajax.send();
  ajax.onload = function () {
