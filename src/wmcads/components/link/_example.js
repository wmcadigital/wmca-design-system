...
const tabs = document.querySelectorAll('ul.wdgt-tab-labels > li');
const panelQuestions = document.querySelectorAll('.wdgt-panel-question');
...
const onTabClick = e => {
  ...
  const tabsPanel = document.querySelectorAll('.wdgt-single-panel');
...
const onQuestionClick = e => {
  ...
  const tabQuestion = document.querySelectorAll('.wdgt-panel-content');
