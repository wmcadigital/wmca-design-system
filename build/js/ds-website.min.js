...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/www/ds-website.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/wmcads/components/content-card/_example.js":
/*!********************************************************!*\
  !*** ./src/wmcads/components/content-card/_example.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var cardsJs = function cardsJs() {
  // This script checks the width of each content card and makes its button full width if below 500px
  var cards = Array.from(document.querySelectorAll('.ds-content-card'));
  if (!cards.length) return;
  var buttons = cards.map(function (card) {
    return card.querySelector('.ds-btn');
  });
  function cardButtonWidth() {
    cards.forEach(function (container, i) {
...
/* harmony default export */ __webpack_exports__["default"] = (cardsJs);
  ...
  */
  ...
  megaMenus.forEach(function (menu) {
    ...
    document.addEventListener('DOMContentLoaded', function handleDOMContentLoaded() {
      var menuButtons = document.querySelectorAll('[aria-haspopup="true"]');
...
var componentExampleIframe = function componentExampleIframe() {
  ...
  iframeExamples.forEach(function (iframeElement) {
    ...
    ajax.open('GET', "".concat(host, "/img/ds-icons.min.svg"), true); // Fire off ajax to get spritesheet
    ajax.send();
...
var seeExampleFullScreen = function seeExampleFullScreen() {
  ...
  var style = document.body && document.body.style ? document.body.style : document.documentElement.style;
  fullScreenBtns.forEach(function (btn) {
    var btnEle = btn; // Grab ele of btn and map to const to avoid mutation
    var codeExampleDiv = btnEle.closest('.ds-website-code-example') || btnEle.parentElement; // Get nearest example wrapper or fallback to parent
    ...
    var _handleFullScreenKeyDown = function handleFullScreenKeyDown(e) {
      ...
      if (isEscPressed) {
        closeFullScreen();
        document.removeEventListener('keydown', _handleFullScreenKeyDown); // Remove listener as we want to go back to normal keyboard events
      }
    ...
    var handleClick = function handleClick() {
      ...
      var openFullScreen = function openFullScreen() {
        ...
        document.addEventListener('keydown', _handleFullScreenKeyDown); // Add listener to key events for full screen
      };
...
/*!******************************************************!*\
  !*** ./src/www/_partials/component-example/index.js ***!
  \******************************************************/
/*! exports provided: componentExample, componentExampleIframe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "componentExampleIframe", function() { return _component_example_iframe__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
var _polyfills = __webpack_require__(/*! ./assets/vendor/js/polyfills/polyfills */ "./src/www/assets/vendor/js/polyfills/polyfills.js");
var _colorPalettes = __webpack_require__(/*! ./pages/wmca/styles/colour-palettes/_color-palettes */ "./src/www/pages/wmca/styles/colour-palettes/_color-palettes.js");
var _aToZContentStyleGuide = __webpack_require__(/*! ./pages/wmca/styles/a-to-z-content-style-guide/_a-to-z-content-style-guide */ "./src/www/pages/wmca/styles/a-to-z-content-style-guide/_a-to-z-content-style-guide.js");
// const _cookies = require('../wmcads/patterns/cookies/_example');
var _headerJs = __webpack_require__(/*! ../wmcads/patterns/header-v2/_example */ "./src/wmcads/patterns/header-v2/_example.js");
var _footerJs = __webpack_require__(/*! ../wmcads/patterns/footer/_example */ "./src/wmcads/patterns/footer/_example.js");
var _accordionsJS = __webpack_require__(/*! ../wmcads/components/accordion/_example */ "./src/wmcads/components/accordion/_example.js");
var _boardMembersJS = __webpack_require__(/*! ../wmcads/patterns/board-members/_example */ "./src/wmcads/patterns/board-members/_example.js");
var _searchFilterJs = __webpack_require__(/*! ../wmcads/patterns/search/search-filter/_example */ "./src/wmcads/patterns/search/search-filter/_example.js");
var _feedbackLoopsJS = __webpack_require__(/*! ../wmcads/patterns/feedback-loop/_example */ "./src/wmcads/patterns/feedback-loop/_example.js");
var _cardsJs = __webpack_require__(/*! ../wmcads/components/content-card/_example */ "./src/wmcads/components/content-card/_example.js");
var _partials = __webpack_require__(/*! ./_partials/component-example */ "./src/www/_partials/component-example/index.js");
var polyfills = _polyfills && _polyfills.default || _polyfills;
var colorPalettes = _colorPalettes && _colorPalettes.default || _colorPalettes;
var aToZContentStyleGuide = _aToZContentStyleGuide && _aToZContentStyleGuide.default || _aToZContentStyleGuide;
var headerJs = _headerJs && _headerJs.default || _headerJs;
var footerJs = _footerJs && _footerJs.default || _footerJs;
var accordionsJS = _accordionsJS && _accordionsJS.default || _accordionsJS;
var boardMembersJS = _boardMembersJS && _boardMembersJS.default || _boardMembersJS;
var searchFilterJs = _searchFilterJs && _searchFilterJs.default || _searchFilterJs;
var feedbackLoopsJS = _feedbackLoopsJS && _feedbackLoopsJS.default || _feedbackLoopsJS;
var cardsJs = _cardsJs && _cardsJs.default || _cardsJs;
var componentExample = _partials && _partials.componentExample || _partials && _partials.default && _partials.default.componentExample;
var componentExampleIframe = _partials && _partials.componentExampleIframe || _partials && _partials.default && _partials.default.componentExampleIframe;
...
/******/ });
//# sourceMappingURL=ds-website.min.js.map